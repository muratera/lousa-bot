...
exports.run = async (client, message, args) => {
   if (!message.member.hasPermission("")) return message.channel.send(':hayirr: | Bu komutu kullanabilmek için `Yönetici` yetkisine sahip olmalısın!')
...
exports.help = {
    ...
    usage: 'herkeserolver @rol / rol-ismi'
}