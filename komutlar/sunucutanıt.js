...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .setDescription('Sunucu [burada](https://discord.gg/zKXnTDP tanıtıldı! \n\n 12 saat Sonra sunucunuzu Tekrardan Tanıtabilirsiniz. \n\n Sunucunu tanıtabilmek için beni [ekle!](https://discordapp.com/oauth2/authorize?client_id=525313553734041600&scope=bot&permissions=2146958847)')
  .setColor('GREEN')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('533408512076677120').send(embed)
            });
  ...
  message.channel.send({embed: {
      description: '**BAŞARISIZ TANITIM** \n\nBu komut zaten kullanılmış!\n\nSunucunu 12 saate 1 defa tanıtabilirsin! \n\n[Rosemary | Discord.js | Kod Paylaşım](https://discord.gg/zKXnTDP) \n[Rosemary Ekle](https://discordapp.com/oauth2/authorize?client_id=532272597556002828&scope=bot&permissions=2146958847)'
            }});
  }
};
exports.conf = {
